# -*- coding: utf-8 -*-
"""Consistency check for the pectoral-fin rate: recompute it and compare with the merged table.

The counting rule comes from postproc.py (cycle 3 -> 4 -> 3, intermediate state of at least two
...
Input   : <work root>/pectoral.xlsx
Against : <work root>/pectoral/pectoral.xlsx
...
REF_XLSX = os.path.join(RES_DIR, "pectoral_rate.xlsx")
